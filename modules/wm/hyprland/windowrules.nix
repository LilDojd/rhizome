  ...
  flake.modules.homeManager.hyprland = {
    wayland.windowManager.hyprland.settings = {
      windowrule = [
        ...
        "tag +settings, match:class ^(pavucontrol|pwvcucontrol|org.pulseaudio.pavucontrol|com.saivert.pwvucontrol)$"
        ...
        "opacity 0.9 0.8, match:tag terminal*"
        "opacity 0.9 0.8, match:tag settings*"
        "opacity 0.9 0.8, match:class ^(gedit|org.gnome.TextEditor|mousepad)$"
        ...
        "suppress_event maximize, match:class ^(blender)$"
        "no_anim on, match:class ^(blender)$"
